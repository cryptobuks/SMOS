...
\theta_t&=[S_{1t},S^*_{1t},S_{2t},S^*_{2t}], &\  F=[1,0,1,0] \\
 \omega_j&=\frac{2 \pi j}{s}, j=1,2, s=1 \dots 276
\end{align}
\end{equation}
\begin{align*}
G = \begin{bmatrix}
...
\item \textit{MCMC:}\\
We ran 4 chains with sample size of 2500 each, thinning every 10th sample, and considering the first 500 saved iterations as burn in.  A variety of starting values were tried.  The median of $\sigma^2_V$ is .0044 and the median of $\sigma^2_W$ is  and .0033, respectively.  That gives a signal to noise ratio of $W/V=0.756$.  The potential scale reduction factor, $\hat{R}$, was 1 for each posterior distribution.  The MLE for $\sigma^2_V$ is .0025 and the MLE of $\sigma^2_W$ is .000176, giving $W/V=0.069$.

\begin{figure}[H]
\caption{Trace Plot for Pix 194406 $\sigma^2_V$}
\centering
\includegraphics[height=8cm]{harm2.1.pdf}
\end{figure}

\begin{figure}[H]
\caption{Trace Plot for Pix 104406 $\sigma^2_W$}
\centering
\includegraphics[height=8cm]{harm2.1.pdf}
\end{figure}
